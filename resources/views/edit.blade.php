    ...
    <div class="container mx-auto p-4">
        ...
        <form action="{{ route('user.update', $user) }}" method="POST" class="space-y-4 bg-white p-6 rounded-lg shadow-md">
            ...
            <div>
                ...
                <input type="password" id="password_confirmation" name="password_confirmation" value="{{ $user->password }}" class="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm">
            </div>
